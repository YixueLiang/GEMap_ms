...
load("DEMap_Data/drug_data_list_20.RData")
lincs_tissue <- names(drug_data_list)

unique(cellinfor$OncotreeLineage)
cellinfor$OncotreeLineage <- gsub("Ovary/Fallopian Tube", "Ovary", cellinfor$OncotreeLineage)
cellinfor$OncotreeLineage <- gsub("Bladder/Urinary Tract", "Bladder", cellinfor$OncotreeLineage)
cellinfor$OncotreeLineage <- gsub("CNS/Brain", "CNS", cellinfor$OncotreeLineage)
cellinfor$OncotreeLineage <- gsub("Vulva/Vagina", "Vulva", cellinfor$OncotreeLineage)
cellinfor$OncotreeLineage <- gsub("Esophagus/Stomach", "Esophagus and Stomach", cellinfor$OncotreeLineage)

cellinfor <- cellinfor[cellinfor$OncotreeLineage %in% lincs_tissue, ]
